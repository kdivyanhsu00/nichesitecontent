...
class Setting extends Model
{
    ...
    public static function homepage_form_elements()
    {
        return [
            ...
            'faq_question_1' => 'input',
            'faq_question_1_answer' => 'textarea',
            'faq_question_2' => 'input',
            'faq_question_2_answer' => 'textarea',
            'faq_question_3' => 'input',
            'faq_question_3_answer' => 'textarea',
            'faq_question_4' => 'input',
            'faq_question_4_answer' => 'textarea',
            'faq_question_5' => 'input',
            'faq_question_5_answer' => 'textarea',
