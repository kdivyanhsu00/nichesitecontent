...
class CreateDummyData extends Command
{
    ...
    private function paymentGateways()
    {
        PaymentGateway::insert([
            ...
            [
                ...
                'keys' => json_encode([
                    'client_id' => "ASurpZzLelJpjJCwFSCaStoV71rjInqmmEWkDn2mWk8bxGVZifdUgW_Y59tWRCFyx-no7AUW8ozjzGb6Cc",
                    'client_secret' => "EDta8P64QXuKQYoD8GwhldNaROaySGai0pYwoJXGzBjCBc-5BfdZ6Ud_pgBQmlWb6WQyFMQvhjJh6noxsqh",
                    'environment' => 'sandbox',
                ]),
            ...
            [
                ...
                'name' => 'Braintree',                
                'keys' => json_encode([                    
                    'merchant_id' => 'z5sjjhbgrbzfsgnw6',
                    'public_key' => 'n6srpqmqn6mq5asdv',
                    'private_key' => '59f9e4bf4b14s9f54fasa553fb9c7f7c137',
            ...
            [
                ...
                'name' => 'Stripe',           
                'keys' => json_encode([                    
                    'publishable_key' => 'pk_test_JBnqGXsZs3sHVpaR4bBwPFXoTm',
                    'secret_key' => 'sk_test_9rRMThBsLosdJauBIbTIVuP4Q',
                ]),
    ...
    private function email()
    {
        DotenvEditor::setKeys([
            ...
            ['key' => 'MAIL_USERNAME', 'value' => 'ab2e6818s8f741d2'],
            ['key' => 'MAIL_PASSWORD', 'value' => '0b3bf07bda5204f'],
