    ...
    <tbody>
      ...
      <tr>
        ...
        <td style="width: 40%;">
        	...
        	<div><small class="form-text text-muted">Submitted at : {{ $work->created_at }}</small></div>
        ...
        <td style="width: 40%;">
        	...
        	<div><small class="form-text text-muted">Posted at : {{ $work->updated_at }}</small></div>   	@endif
        </td>        
      </tr>
      @endforeach
    </tbody>
