<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
   ...
   <div class="dropdown dropright">
      ...
      <div class="dropdown-menu" aria-labelledby="dropdownMenuLink"> 
         <a class="dropdown-item" href="{{ route('services_list') }}">Project</a>
         <a class="dropdown-item" href="{{ route('urgencies_list') }}">Deadlines</a>
         <a class="dropdown-item" href="{{ route('work_levels_list') }}">Language</a>
         <a class="dropdown-item" href="{{ route('additional_services_list') }}">Add Ons
         </a>
   ...
   <div class="dropdown dropright">
      ...
      <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
         ...
         <a class="dropdown-item" href="{{ route('settings_edit_content', 'about') }}">About</a>
         <div class="dropdown-divider"></div>
